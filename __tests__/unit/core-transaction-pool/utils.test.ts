...
import devnetMilestones from "@tycoon69-labs/crypto/src/networks/devnet/milestones.json";
import mainnetMilestones from "@tycoon69-labs/crypto/src/networks/mainnet/milestones.json";
